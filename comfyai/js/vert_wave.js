(function() {
    ...
    var NUM_WIDTH_PTS = 28;
    var NUM_HEIGHT_PTS = 28;
    ...
    context.viewport(0, -200, canvas.width, 900);
    context.clearColor(.0745, .0745, .0745, 1);
    context.enable(context.DEPTH_TEST);

    var persp = mat4.create();
    mat4.perspective(45.0, 0.5, 0.1, 80.0, persp);
    ...
    (function animate(){
		...
		context.uniform1f(u_timeLocation, u_time += 0.001);
